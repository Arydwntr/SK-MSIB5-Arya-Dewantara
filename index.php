                    ...
                    <div class="hero__search">
                        ...
                        <div class="hero__search__phone">
                            <div class="hero__search__phone__icon">
                                <i class="fa fa-phone" style="color: #00FF7F;"></i>
                            </div>
                            ...
                            <div class="carousel-item active" style="height: 350px;">
                                ...
                                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                    <div class="p-3" style="max-width: 700px;">
                                        ...
                                        <h3 class="display-4 text-white font-weight-semi-bold mb-4">Tatara Farma</h3>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
                        <h1 class="fa fa-check m-0 mr-3" style="color: #87CEEB;"></h1>
                        <h5 class="font-weight-semi-bold m-0">Kualitas Produk</h5>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
                        <h1 class="fa fa-truck m-0 mr-2" style="color: #87CEEB;"></h1>
                        <h5 class="font-weight-semi-bold m-0">Pengantaran Gratis</h5>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
                        <h1 class="fa fa-exchange m-0 mr-3" style="color: #87CEEB;"></h1>
                        <h5 class="font-weight-semi-bold m-0">Pengembalian Barang</h5>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
                        <h1 class="fa fa-phone-square m-0 mr-3" style="color: #87CEEB;"></h1>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> 09 November 2023</li>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> 10 November 2023</li>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> 11 November 2023</li>
